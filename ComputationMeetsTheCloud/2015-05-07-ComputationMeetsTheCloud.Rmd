...
sThisPostMd <- paste0(sThisPost,".md")
...
sPostMdDir <- file.path(sGitHome,"charlotte-ngs.github.io/_posts")
sImageSourceDir <- "pic"
sImageBaseUrl <- paste("http://charlotte-ngs.github.io/img/", sThisPost, sep = "")
### # check whether RGhpBlogTools is installed
stopifnot(is.element("RGhpBlogTools", installed.packages()))
### # set defaults
RGhpBlogTools::SetRGhpBlogToolOptions(psImgSrcDir  = sImageSourceDir, 
                                      psImgBaseUrl = sImageBaseUrl, 
                                      psPostImgDir = sPostImgDir, 
                                      psStatus     = sStatus)
if (sStatus == "publish") RGhpBlogTools::MovePushImg()
```
...
sPicUrl <- RGhpBlogTools::sGenerateImgLink(psImgFn = "smc_start_screen.png", 
                                           psImgText = "SMC start screen")
cat(sPicUrl, "\n")
```
...
```{r, echo=FALSE, results='asis'}
sPicUrl <- RGhpBlogTools::sGenerateImgLink(psImgFn = "CreateNewProjectButton.png", 
                                           psImgText = "Create New Project Button")
cat(sPicUrl, "\n")
```
...
```{r, echo=FALSE, results='asis'}
sPicUrl <- RGhpBlogTools::sGenerateImgLink(psImgFn = "CreateNewProjectPopUp.png", 
                                           psImgText = "Create New Project Popup")
cat(sPicUrl, "\n")
```
