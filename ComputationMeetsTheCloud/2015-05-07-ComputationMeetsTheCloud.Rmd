...
This post introduces the potential synergies of computer algebra and cloud computing. Recently, there has been a debate on some [blogs](http://www.r-bloggers.com/choosing-r-or-python-for-data-analysis-an-infographic) whether one should choose `R` or `python` for data analysis. In what follows, I might argue to consider the following points:

* In case, data analysis involves the derivation of symbolic formula, it is worthwhile considering a computer algebra system (CAS)
* Systems that are available via the cloud such as SMC have the great advantage that they can be used without any burden of application installation.
