...
```{r Prereq, echo=FALSE,results='hide', eval=bOnLine}
#sContribUrl <- "https://cran.rstudio.com/src/contrib"
#vReqPack <- c("inline")
#for (p in vReqPack){
#  if (!require(p)){
#    install.packages(pkgs = p, contriburl = sContribUrl)
#    require(p)
#  }
#}
require(inline)
...
fibR <- cxxfunction(signature(xs = "int"),
                    plugin = "Rcpp",
                    incl = incltxt,
                    body = '
